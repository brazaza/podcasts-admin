          ...
          <div className="space-y-4">
            ...
            >
              <Link
                ...
                className="block group/title w-fit max-w-full overflow-hidden"
              >
                <h1
                  className={`${getTitleSize()} font-black tracking-tighter uppercase leading-[0.9] font-display text-yellow-400 transition-colors`}
                >
